...
const CountryCard = ({ country }) => {
    ...
    const { capital, region, population, cca2 } = country;
                ...
                <NavLink to={`/countrydetails/${cca2}`}>
                    <div className='hover:bg-blue-50 transition'>
                        <div className='flex-1 mx-auto bg-amber-50 hover:bg-amber-100 w-full transition p-4'>
                            <img className='h-36 object-contain mx-auto rounded-lg' src={flag} alt={flagAlt} loading='lazy'></img>
                        </div>
                        <div className='p-4 space-y-2 text-sm'>
                            ...
                            <div className='flex justify-between'>
                                ...
                                <span title='Population'>{displayPopulation}</span>
                            </div>
                        </div>
                    </div>
                </NavLink>
